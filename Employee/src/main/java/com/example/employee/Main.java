...
public class Main {
    public static void main(String[] args) {
        ...
        Employee newEmployee1 = new Employee(1, "Bella", "Software Engineer", 8000, java.sql.Date.valueOf("2020-01-15"));
        Employee newEmployee2 = new Employee(2, "Kim", "HR Manager", 9000, java.sql.Date.valueOf("2019-03-22"));
        Employee newEmployee3 = new Employee(3, "Alice", "SMM", 95000, java.sql.Date.valueOf("2021-07-10"));
